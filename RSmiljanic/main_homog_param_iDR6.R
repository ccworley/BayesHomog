...
# DEFINITIONS
release <- c('iDR6')
list.nodes <- c('CAUP','EPINARBO','IACAIP','Lumba','Nice','OACT','Vilnius','Arcetri')
node.template.file <- c('GES_iDR6_WG11_NodeTemplate_QC_09042018.fits')
node.files.path <- c('/work/rsmiljanic/Survey/DR6/Nodes/')

# Source the file with definitions of functions for plots and other tasks
source(paste('/work/rsmiljanic/Survey/',substr(release,2,nchar(release)),'/Codes/ToClare/homog_plots.R',sep=''))
...
flags.to.ignore.specific <- c("10151-11-02","10153-11-02","10200-11-02","10302-11-02","11020-11-02","13003-11-02","14126-11-02", # CAUP
                              "10302-11-03","10303-11-03","10304-11-03","10305-11-03","10306-11-03","10500-11-03","11020-11-03", # EPINARBO
                              "10151-11-04","13020-11-04","13021-11-04","13022-11-04", # IACAIP
                              "10303-11-05","10304-11-05","10305-11-05","13010-11-05","13028-11-05", # LUMBA
                              "10108-11-08","10151-11-08","10302-11-08","10308-11-08","11020-11-08", # Nice
                              "10303-11-09","11050-11-09","11100-11-09","11150-11-09","11200-11-09","11250-11-09","13020-11-09","13022-11-09", # OACT
                              "10152-11-11","10302-11-11","11020-11-11", # UCM
                              "10302-11-13","10303-11-13","10312-11-13", # Vilnius
                              "10303-11-01","10305-11-01","10306-11-01","10312-11-01","10500-11-01","10602-11-01","11020-11-01","13020-11-01","13022-11-01","13023-11-01") # Arcetri

#     CAUP: 10025 SNR<25; 10151 no RV; 10153 discrepant RV; 10200 no vsini; 10302 code convergence; 13003 xi > 3; 14126 high FeI dispersion
# EPINARBO: 10005, 10010, 10015, 10020, 10025, 10030 innacurate result because of SNR; 10300 key setup is missing; 10302, 10303, 10304, 10305, 10306 code convergence issues; 10308 parameter outside node grid; 10311, 10312 too few FeI/FeII lines; 10399 lack of time; 10500 no EW measured; 11020 vsini>20; 13021, 13023 suspicious parameter
#   IACAIP: 10105 incomplete spectrum; 10151 no RV; 13020, 13021, 13022 suspicious parameter; 
#    Lumba: 10303 code convergence; 10399 lack of time; 13002 xi>2; 13028 suspicious param because of high vsini
#     Nice: 10010 SNR<10; 10105 incomplete spectrum; 10151 no RV; 10302 code convergence; 10308 outside grid; 11020 vsini>20
#     OACT: 10010,15,20,30 SNR<10,15,20,30; 10105,10106 incomplete/broken spectrum; 10303 code convergence; 10320 suspected multiple system; 11100,11150,11200,11250 vsini>100,150,200,250; 13020,13022 suspicious parameter grid edge; 13027 suspicious parameter multiple system
#  Vilnius: 10005,10010 SNR<5,10; 10302,10303 code convergence
#      UCM: 10020 no results,innacurate; 10302 code convergence, 11020 too high vsini
...
# Remove weird results of IACAIP
...
bench.path <- paste('/work/rsmiljanic/Survey/DR6/Support/')
