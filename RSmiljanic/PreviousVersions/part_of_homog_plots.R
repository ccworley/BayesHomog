...
# Plots for homog of iDR4 - Modified for iDR5
# Partial extract to circulate for iDR6 homog
...
library(gplots)
######################
list.of.nodes <- c('CAUP','Lumba','Nice','OACT','UCM','Vilnius')
this.release <- c('iDR5')
...
#
    list.files <- paste0(where.files,'GES_',substr(release,1,4),'_WG11_',list.nodes,'.fits',sep="")
